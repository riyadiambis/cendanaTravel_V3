...
$faqData = [
    [
        ...
        'items' => [
            [
                'question' => 'Bagaimana cara memesan tiket melalui Cendana Travel?',
                'answer' => 'Anda dapat memesan tiket dengan beberapa cara: (1) Melalui website kami di halaman Pemesanan, (2) Menghubungi WhatsApp kami di 085821841529, atau (3) Datang langsung ke kantor kami di Jl. Cendana No.8, Samarinda. Tim kami akan membantu Anda memilih paket terbaik sesuai kebutuhan.'
            ],
            [
                'question' => 'Apakah bisa memesan tiket untuk grup atau rombongan?',
                'answer' => 'Tentu saja! Kami melayani pemesanan untuk individu, grup kecil, hingga rombongan besar. Untuk pemesanan grup, kami memberikan diskon khusus dan layanan khusus seperti koordinasi check-in grup, handling bagasi, dan pendampingan perjalanan. Hubungi kami untuk mendapatkan penawaran terbaik.'
            ],
            [
                'question' => 'Berapa lama waktu yang dibutuhkan untuk konfirmasi pemesanan?',
